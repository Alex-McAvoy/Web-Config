...
public class BaseTest {
    ...
    /**
     * @Description: 不使用 dao 接口情况下的 sql 语句调用（目前该方式已弃用）
     * @Param: []
     * @Return: void
     * @Author: Alex McAvoy
    ...
    public void testSql() {
         ...
         * **/
        Employee employee = sqlSession.selectOne("com.mybatis.dao.base.EmployeeMapper.getEmployeeById", 1);
    ...
    /**
     * @Description: 使用 dao 接口后的 sql 语句调用（目前常用该方式）
