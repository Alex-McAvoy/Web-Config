...
public class TestPersistence {
    ...
    /**
     * @Description: 类似于 Hibernate 中的 Save 方法，使对象由临时状态变为持久化状态
    ...
    /**
     * @Description: 根据 id 查找数据表的对象，相当于 Hibernate 中 Session 的 get 方法
    ...
    /**
     * @Description: 根据 id 查找数据表的对象，相当于 Hibernate 中 Session 的 load 方法
    ...
    /**
     * @Description: 类似于 Hibernate 的 delete 方法，但该方法只能移除持久化对象，
...
//        session.delete(user);
    ...
    /**
     * @Description: 类似 Hibernate 的 saveOrUpdate 方法
    ...
    /**
     * @Description: 同 Hibernate 中的 flush 方法
     * @Param: []
     * @Return: void
     * @Author: Alex McAvoy
    ...
    /**
     * @Description: 同 Hibernate 中的 refresh 方法
     * @Param: []
     * @Return: void
     * @Author: Alex McAvoy
