...
import com.jpa.entity.bionetoone.Work;
import com.jpa.entity.bionetoone.Worker;
...
public class TestBiOneToOne {
    ...
    /**
     * @Description: 运行后生成相应 works 和 workers数据表
     * @Param: []
     * @Return: void
     * @Author: Alex McAvoy
