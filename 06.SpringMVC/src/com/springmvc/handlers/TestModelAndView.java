...
public class TestModelAndView {
    ...
    /**
     * @Description: 返回值为 ModelAndView 类型，其中可以包含视图和模型信息
    ...
    /**
     * @Description: Map 类型参数的数据会放到 Request 域对象中
     * @Param: [map]
    ...
    /**
     * @Description: @SessionAttributes() 放与类声明之前，可以将属性放到 session 中（使用 value 属性）
    ...
    public String testSessionAttributes(Map<String, Object> map) {
        ...
        map.put("user", user);
        map.put("school", "123"); //通过 @SessionAttributes() 中的 type 来指定存放 String 类型
        return SUCCESS;
    }
    ...
    /**
     * @Description: 由 @ModelAttribute 标记的方法，会在每个目标方法执行前被 SpringMVC 调用
