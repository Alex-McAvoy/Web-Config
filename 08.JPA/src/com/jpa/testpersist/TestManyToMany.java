...
import com.jpa.entity.manytomany.Category;
import com.jpa.entity.manytomany.Item;
...
public class TestManyToMany {
    ...
    /**
     * @Description: 运行后生成相应 items、categories、item-category 数据表
     * @Param: []
     * @Return: void
     * @Author: Alex McAvoy
    ...
    /**
     * @Description: 多对多关系查询操作，对于关联的集合对象，默认使用懒加载策略
